-- Phase 2: cold history for messages (run once on existing fresh DBs).
-- Hot path stays on public.messages; deep history can query messages_archive.
...
-- Extra hot-table index for group catch-up (Phase 2 item 22).
